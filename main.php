	...
	<header style="padding-top: 10px; padding-bottom: 25px; background: none repeat scroll 0% 0% rgb(255, 255, 255); box-shadow: none;" id="header" class="show-original-logo solid-header">
		<div class="centered-wrapper">
			<div class="percent-one-fourth ">
				<div class="logo">
					<a class="original-logo" href="#home"><img style="width: auto; height: 70px;" src="files/DDLogo2.jpg" alt="AAP Logo"></a>
						...
						<div class="col-sm-12 col-md-6 col-lg-6">
							<div >
								<object width="100%" height="349">
								  <param name="movie"
										 value="http://www.youtube.com/v/posLIVQelA4"></param>
								  <param name="allowScriptAccess" value="always"></param>
								  <embed src="http://www.youtube.com/v/posLIVQelA4"
